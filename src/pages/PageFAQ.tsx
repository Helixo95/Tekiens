...
const FAQ = () => {
    return (
        <IonPage>
            ...
            <IonContent className="justify-text">
                <div>
                    <h1 className='questionTitle'>Informations générales</h1>
                    <h5 className='questionSecondTitle'>Qu'est-ce que tekiens.net et quel est son objectif ?</h5>
                ...
                <div>
                    <h1 className='questionTitle'>Utilisation de la plateforme</h1>
                    <h5 className='questionSecondTitle'>Comment puis-je ajouter mon association sur tekiens.net ?</h5>
                    <span className='questionAnswer'>
                ...
                <div>
                    <h1 className='questionTitle'>Contribution et support</h1>
                    <h5 className='questionSecondTitle'>Comment puis-je contribuer au projet ?</h5>
                    <span className='questionAnswer'>
                    ...
                    <h5 className='questionSecondTitle'>Comment puis-je trouver le code source de tekiens.net ?</h5>
                    <span className='questionAnswer'>
                    ...
                    <h5 className='questionSecondTitle'>Comment puis-je signaler un problème ou un bug ?</h5>
                    <span className="questionAnswer">
